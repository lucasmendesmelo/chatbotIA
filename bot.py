...
api = requests.get("https://editacodigo.com.br/index/api-whatsapp/32ZTzwA5LsihcGpnVfAgblHvM7EE75SZ" ,  headers=agent)
time.sleep(1)
api = api.text
api = api.split(".n.")
token1 = api[0].strip()
    ...
    if event == 'ENTRAR':
        ...
        if senha == token1 :
            ...
            if event2 == 'CAPTURAR QRCODE':
                ...
                chrome_options2.add_argument("user-data-dir=" + dir_path + "profile/zap")
